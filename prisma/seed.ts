...
async function seedDatabase() {
  try {
    ...
    const creativeNames = [
      ...
      "Lenhador BarberPub",
      "London Barbearia",
      "Barbearia das estrelhas",
      "Rodrigo Barbearia",
      "RR Barbershop",
      "Barberteam Barbeiros",
      "Betinho Barber Club",
      "Barbearia Benevides",
    ];

    const addresses = [
      "Rua Irineu Joffily, 305, Centro",
      "Rua Getúlio Cavalcante, 556, Liberdade",
      "Rua Desembargador Trindade, 239, Centro",
      "Rua Vigário Calixto, 575, Catolé",
      "Rua Aprígio Veloso, S/N, Bodocongó",
      "Rua Sargento Hermes Ferreira Ramos, 945, Bela Vista",
      "Rua Coronel José Vicente, 107, Bela Vista",
      "Rua Coronel José Vicente, 82A, Bela Vista",
      "Rua Floripedes Coutinho, 614A, Bodocongó",
      "Rua Luiz Ferreira da Silva, 55A, Acácio Figueiredo",
    ];
    ...
    for (let i = 0; i < 10; i++) {
      ...
      const barbershop = await prisma.barbershop.create({
        data: {
          ...
          address,
          imageUrl,
          phones: ["(83) 98765-4321"],
          description: "Barbearia de qualidade",
        },
      });
